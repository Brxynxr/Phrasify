...
function App() {
  ...
  // 1. Capa de presentación (Landing Page limpia)
  if (vistaActiva === 'landing') {
    return (
      <div className="min-h-screen text-slate-100 flex flex-col font-sans relative bg-transparent animate-fade-in">
        {/* Fondo Gótico */}
  ...
  // 2. Capa del Portal Interactivo (Aplicación Principal con botones y navegación)
  return (
    <div className="min-h-screen text-slate-100 flex flex-col font-sans relative bg-transparent animate-fade-in">
